        ...
        <div className="container">
          ...
          <div className="updates-timeline">
            <div className="update-card card">
              ...
              <h3 className="update-title">🚀 v2.0 Release</h3>
            ...
            <div className="update-card card">
              ...
              <h3 className="update-title">📊 Advanced Analytics</h3>
              <ul className="update-list">
            ...
            <div className="update-card card">
              ...
              <h3 className="update-title">🔗 Samsara Integration</h3>
              <ul className="update-list">
            ...
            <div className="update-card card">
              ...
              <h3 className="update-title">🤖 AI Load Extraction</h3>
              <ul className="update-list">
            ...
            <div className="update-card card">
              ...
              <h3 className="update-title">🎉 Initial Launch</h3>
              <ul className="update-list">
