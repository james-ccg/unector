...
type IconName = 'arrow-left' | 'arrow-right' | 'briefcase' | 'check' | 'chevron-right' | 'clock' | 'close' | 'drivers' | 'email' | 'load' | 'location' | 'logout' | 'menu' | 'money' | 'phone' | 'settings' | 'shield' | 'truck' | 'warning'
