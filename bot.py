...
async def handle_faq(message: Message):
    ...
    await message.reply(
        ...
        "paid plan starts with a 7-day free trial, and the trial does not ask for a card.\n"
        "Once a card is on file the plan renews by itself: the price is charged on the "
        "day the trial ends, and every period after, until it is cancelled from Settings. "
        "While a plan or trial is running that last card cannot be removed - add another "
        "to replace it, or take it off once the plan is cancelled.\n\n"
